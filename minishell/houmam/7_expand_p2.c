...
// Function to expand variables in a string, respecting double quotes
// char* expand_variables(const char* input)
// {
//     size_t input_length = strlen(input);
...
//     size_t i = 0, j = 0;
//     int inside_quotes = 0; // Flag to track whether we're inside double quotes
...
// // Function to expand variables in a string, handling variables, and escaped quotes
// char* expand_variables(const char* input) {
//     size_t input_length = strlen(input);
//     char* expanded = (char*)malloc((input_length * 2 + 1) * sizeof(char));
...
//             }
//             expanded[j++] = input[i++];
//         } else if (!inside_double_quotes && !inside_single_quotes && input[i] == '$') {
//             i++; // Skip '$'
...
//////////////////////////////////////// jsut little bit to perfect code //////////////////////////////////////////
//////////////////////////////////////// jsut little bit to perfect code //////////////////////////////////////////
//////////////////////////////////////// jsut little bit to perfect code //////////////////////////////////////////
//////////////////////////////////////// jsut little bit to perfect code //////////////////////////////////////////
//////////////////////////////////////// jsut little bit to perfect code //////////////////////////////////////////
...
// {
//     size_t input_length = strlen(input);
//     char* expanded = (char*)malloc((input_length * 1024 + 1) * sizeof(char));
